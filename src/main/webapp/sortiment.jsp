...
<div class="container">
  ...
  <h1 class="my-4">Sortiment
    <small>Vi har de bedste priser og de bedste carporte syd for Byzantium!</small>
  </h1>
...
Udførlig byggevejledning til carport og spær medfølger.
Betontagsten i sort med 30 års garanti.
NB! Leveres som Byg-selv sæt - usamlet og ubehandlet! Pr. stk. 13.998,-
...
Udførlig byggevejledning til carport og spær medfølger.
Betontagsten i sort med 30 års garanti.
NB! Leveres som Byg-selv sæt - usamlet og ubehandlet! Pr. stk. 23.498,-
<br><button onclick="window.location.href = 'shop.jsp';">Bestil!</button></p>
        </div>
      </div>
    </div>
...
Udførlig byggevejledning til carport og spær medfølger.
Betontagsten i sort med 30 års garanti.
NB! Leveres som Byg-selv sæt - usamlet og ubehandlet! Pr. stk. 22.998,-<br><button onclick="window.location.href = 'shop.jsp';">Bestil!</button>
          </p>
        </div>
      </div>
    </div>
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <p class="card-text">3,00 x 4,80 mtr. Højde; 2,25 mtr. Trykimprægnerede stolper og stern. 
Leveres med: søm, skruer, beslag og plasttrapez tag m/bundskruer.
NB! Leveres som Byg-selv sæt - usamlet, umalet og ubehandlet! Pr. stk. 3.998
<br><button onclick="window.location.href = 'shop.jsp';">Bestil!</button>
          </p>
        </div>
      </div>
    </div>
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <p class="card-text">3,00 x 6,20 mtr. incl. 1,50 x 2,70 mtr. redskabsrum. Højde; 2,25 mtr.
Trykimprægnerede stolper, stern og beklædning.
Leveres med: søm, skruer, beslag og plasttrapez tag m/bundskruer.
Udførlig byggevejledning medfølger.
NB! Leveres som Byg-selv sæt - usamlet og ubehandlet! Pr. stk. 9.498,-
<br><button onclick="window.location.href = 'shop.jsp';">Bestil!</button>
          </p>
        </div>
      </div>
